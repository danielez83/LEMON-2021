...
#%% Filter data?
if apply_filter == 'yes':
    time_constant_buttw = 10 # seconds
    n = 2                    # butterworth order
    Omega_c = 1/(time_constant_buttw) # Time constant
    b, a = signal.butter(n, Omega_c, 'low') # Build butterworth filter
    Picarro_data_calibrated['H2O'] = signal.filtfilt(b, a, Picarro_data_calibrated['H2O'])
    Picarro_data_calibrated['d18O'] = signal.filtfilt(b, a, Picarro_data_calibrated['d18O'])
    Picarro_data_calibrated['dD'] = signal.filtfilt(b, a, Picarro_data_calibrated['dD'])
