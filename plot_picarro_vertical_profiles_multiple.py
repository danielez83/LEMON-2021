...
if display == 'raw':
    ...
    for filename in data_filename:
        ...
        ax[0].set_xlabel('H$_2$O (ppm)', fontsize=32)
        ...
        ax[2].tick_params(axis='both', which='major', labelsize=36)
        #ax[2].yaxis.set_ticklabels([])
        ax[2].set_xlabel('$\delta$D (‰)', fontsize=32)
        ...
        ax[3].tick_params(axis='both', which='major', labelsize=36)
        #ax[3].yaxis.set_ticklabels([])
        ax[3].set_xlabel('d-excess (‰)', fontsize=32)
        #ax[3].set_xlim([0, 25])
